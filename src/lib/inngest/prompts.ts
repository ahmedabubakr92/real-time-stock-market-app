...
IMPORTANT: Do NOT start the personalized content with "Welcome" since the email header already says "Welcome aboard {{name}}". Use alternative opennings like "Thanks for joining", "Great to have you", "You're all set", "Perfect timing", etc.
...
CRITICAL FORMATTING REQUIREMENTS:
    ...
    - Make every word count towards personalization
    - Second sentence should add helpful context to reinforce the personalization

Example personalized outputs (showing obvious customization with TWO sentences):
<p class="mobile-text" style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">Thanks for joining Signalist—since you're focused on <strong>technology growth stocks</strong>, you'll love our curated daily digest covering companies like the ones you're tracking. We'll help you spot opportunities before they become mainstream news.</p>

<p class="mobile-text" style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">Great to have you aboard—your <strong>conservative retirement strategy</strong> is a perfect fit for our noise-free dividend monitoring tools. You can track your portfolio progress with confidence and clarity.</p>

<p class="mobile-text" style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">You're all set to begin investing, and we've designed simple tools to help you build confidence while learning the <strong>healthcare sector</strong> you're interested in. Your personalized daily digest will keep you informed without confusing jargon.</p>
`;
...
- Use these sepcific CSS classes and styles to match the email template 
...
- Make each articl easy to scan with clear spacing and structure 
...
- Explain what the news means for regular people can understand and use 
